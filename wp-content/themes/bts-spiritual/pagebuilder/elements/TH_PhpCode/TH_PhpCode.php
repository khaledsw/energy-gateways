...
class TH_PhpCode extends ZnElements
{
	...
	function element()
	{
		...
		if(isset($options['page_php_code_text']) && ! empty($options['page_php_code_text']))
		{
			...
			$comment = '<?php /*[EGW Theme] This file was automatically generated by the PHP Code element. You should not edit this file unless you know what you\'re doing! */ if(!defined("ABSPATH")){return;}'.PHP_EOL;

			if(false === ($pos = stripos($code, '[EGW Theme]'))) {
