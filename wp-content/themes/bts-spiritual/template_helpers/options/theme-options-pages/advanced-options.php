...
$admin_options[] = zn_options_video_link_option( '', __( 'Icon fonts uploader', 'zn_framework' ), array(
    'slug'        => 'advanced_options',
    'parent'      => 'advanced_options'
));
...
$admin_options[] = zn_options_video_link_option( '', __( 'Add custom CSS', 'zn_framework' ), array(
    'slug'        => 'custom_css',
    'parent'      => 'advanced_options'
));
$admin_options[] = zn_options_doc_link_option( '', array(
    'slug'        => 'custom_css',
    'parent'      => 'advanced_options'
));
...
$admin_options[] = zn_options_video_link_option( '', __( 'Add custom JS', 'zn_framework' ), array(
    'slug'        => 'custom_js',
    'parent'      => 'advanced_options'
));
