	...
	function zn_layout_manager_infonotice(){
		...
		if($screen->id == 'edit-zn_layout'){
			...
			<div class="notice notice-info is-dismissible">
		        <p><?php
		        	echo sprintf( __('Page layouts can be used to apply/override specific theme options to one or multiple pages. <a href="%s" target="_blank">Read more</a>.' , 'zn_framework'), esc_url( '' ) );
	        	?></p>
		    </div>
			<?php
		}
