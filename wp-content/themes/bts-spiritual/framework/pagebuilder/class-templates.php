	...
	function zn_pbsmartareas_infonotice(){
		...
		if($screen->id == 'edit-znpb_template_mngr'){
			...
			<div class="notice notice-info is-dismissible">
		        <p><?php
		        	echo sprintf( __('Page builder Smart Areas are predefined blocks of page builder elements you can insert in your website\'s pages, globally or per page. <a href="%s" target="_blank">Read more</a>.' , 'zn_framework'), esc_url( '' ) );
	        	?></p>
		    </div>
			<?php
		}
