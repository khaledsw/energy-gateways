				...
				<div class="znfb-row">
					...
					<div class="znfb-col-6">
						<div class="zn-lead-text ">
							...
							<ul>
								<li><a href="<?php echo esc_url(''); ?>" target="_blank"><strong><?php echo ZN()->theme_data['name']; ?> Central Documentation HUB</strong></a></li>
								<li><a href="<?php echo esc_url(''); ?>" target="_blank"><?php echo ZN()->theme_data['name']; ?> Video Tutorials</a></li>
								<li><a href="<?php echo esc_url(''); ?>" target="_blank"><?php echo ZN()->theme_data['name']; ?> Written Documentation</a></li>
								<li><a href="<?php echo esc_url(''); ?>" target="_blank"><?php echo ZN()->theme_data['name']; ?> F.A.Q.</a></li>
								<li><a href="<?php echo esc_url(''); ?>" target="_blank">Support Forums</a></li>
							</ul>
							<p>* All links open in new window.</p>
						</div>
					</div>
