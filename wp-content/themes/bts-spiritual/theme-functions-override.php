...
if ( ! function_exists( 'zn_portfolio_post_type' ) ) {
	...
	function zn_portfolio_post_type(){
		...
		$labels = array (
			...
			'singular_name'      => __( 'Service Item', 'zn_framework' ),
			'add_new'            => __( 'Add New Service Item', 'zn_framework' ),
			'all_items'          => __( 'All Service Items', 'zn_framework' ),
			'add_new_item'       => __( 'Add New Service', 'zn_framework' ),
			'edit_item'          => __( 'Edit Service Item', 'zn_framework' ),
			'new_item'           => __( 'New Service Item', 'zn_framework' ),
			'view_item'          => __( 'View Service Item', 'zn_framework' ),
			'search_items'       => __( 'Search Service Items', 'zn_framework' ),
			'not_found'          => __( 'No Service Items found', 'zn_framework' ),
			'not_found_in_trash' => __( 'No Service Items found in trash', 'zn_framework' ),
			'parent_item_colon'  => __( 'Parent Service:', 'zn_framework' ),
			'menu_name'          => __( 'Service Items', 'zn_framework' ),
		);
...
if ( ! function_exists( 'zn_portfolio_category' ) ) {
	...
	function zn_portfolio_category(){
		...
		$labels = array (
			...
			'menu_name'         => __( 'Service categories', 'zn_framework' ),
